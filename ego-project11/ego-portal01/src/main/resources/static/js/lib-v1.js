...
!function() {
    ...
    a.fn.Jlazyload = function(b, c) {
        if (this.length) {
            var d, e, f = a.extend({type: null,offsetParent: null,source: "data-lazyload",placeholderImage: "/portal/images/blank.gif",placeholderClass: "loading-style2",threshold: 200}, b || {}), g = this, h = function(a) {
...
//		URL_Serv: "http://manage.ego.com/web/item/all?callback=category.getDataService",
		URL_Serv: "http://localhost:8101/rest/item/cat/menu?callback=category.getDataService",
